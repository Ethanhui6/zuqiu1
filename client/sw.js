const VERSION='green-pitch-v18.8.0-20260803-1';
...
const CORE=[
  ...
  './src/services/api/leaderboardApi.js','./src/services/api/authoritativeRunApi.js','./src/services/api/rankingSync.js','./src/services/dataRepository.js','./src/services/localization/zh-CN.js','./src/services/rng.js','./src/services/storage/localLeaderboard.js','./src/services/storage/migrations.js','./src/services/storage/saveManager.js',
  './src/systems/achievement/achievementSystem.js','./src/systems/career/careerSystem.js','./src/systems/career/cycleSystem.js','./src/systems/career/nationalSystem.js','./src/systems/career/objectiveSystem.js','./src/systems/career/ovr.js','./src/systems/career/seasonAwardSystem.js','./src/systems/career/timeAdvanceSystem.js','./src/systems/ending/endingSystem.js','./src/systems/event/eventEngine.js','./src/systems/facility/facilitySystem.js','./src/systems/fan/fanSystem.js','./src/systems/match/matchSystem.js','./src/systems/pace/paceSystem.js','./src/systems/relationship/relationshipSystem.js','./src/systems/schedule/scheduleSystem.js','./src/systems/scoring/scoringSystem.js','./src/systems/training/trainingSystem.js','./src/systems/transfer/transferSystem.js',
  './src/styles/theme.css','./src/styles/base.css','./src/styles/components.css','./src/styles/pages.css','./src/styles/mobile-foundation.css','./src/styles/animations.css',
