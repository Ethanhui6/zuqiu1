...
export function createAppShell({onNavigate,onSave,onBack,onHome,onSpeed}){
  ...
  root.append(header,main,speedDock,nav,overlayRoot,toastRoot);
  return{root,header,main,speedDock,speedLabel,speedControls,nav,overlayRoot,toastRoot,brand,back,save};
}
