// Football Career Simulator - Second Career System
...
class SecondCareer {
  static renderOptions(state) {
    ...
    <div class="glass-panel" style="text-align: center;">
      ...
      <h2 style="color: #1c1c1e; margin-top: 8px;">请选择你的退役转型道路</h2>
      ...
      <div class="options-container">
        ${GAME_CONFIG.SECOND_LIFE_CAREERS.map(c => `
          <button class="option-btn" onclick="startSecondCareer('${c.id}')">
            <span class="opt-tag" style="background: var(--apple-blue); color: #fff;">第二职业</span>
