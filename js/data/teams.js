// Football Career Simulator V11.0 - 100+ World Teams Database

const REAL_TEAMS = [
  // --- S Tier: European Elite Giants ---
  ...
  // --- A Tier: European Contenders / Premier League Powers ---
  ...
  { id: "atletico", name: "马德里竞技", country: "🇪🇸 西班牙", tier: "A", rating: 84, league: "西甲", color: "#CB3524", accent: "#272E61" },
  ...
  { id: "leverkusen", name: "勒沃库森", country: "🇩🇪 德国", tier: "A", rating: 84, league: "德甲", color: "#E32219", accent: "#000000" },

  // --- B Tier: Mid-table Big League / Asian Top / MLS / Saudi ---
  { id: "al_hilal", name: "利雅得新月", country: "🇸🇦 沙特", tier: "B", rating: 78, league: "沙特联", color: "#0054A6", accent: "#FFFFFF" },
  { id: "al_nassr", name: "利雅得胜利", country: "🇸🇦 沙特", tier: "B", rating: 77, league: "沙特联", color: "#FFF000", accent: "#003893" },
  ...
  { id: "jeonbuk", name: "全北现代", country: "🇰🇷 韩国", tier: "B", rating: 73, league: "K联赛", color: "#00512C", accent: "#FDE100" },

  // --- C Tier: Chinese Super League Powerhouses ---
  ...
  { id: "chengdu_rongcheng", name: "成都蓉城", country: "🇨🇳 中国", tier: "C", rating: 69, league: "中超", color: "#E31D1A", accent: "#000000" },

  // --- D Tier: CSL Mid-lower / Starting Youth Clubs ---
  ...
  { id: "qingdao_hainiu", name: "青岛海牛", country: "🇨🇳 中国", tier: "D", rating: 59, league: "中超", color: "#FF6600", accent: "#003399" },
