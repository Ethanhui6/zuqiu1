...
const phases = ['青年队训练', '预备队比赛', '替补登场', '轮换首发', '主力竞争', '杯赛淘汰赛', '联赛冲刺', '客场逆境', '连续作战', '合同观察期', '转会考察', '国家队集训', '伤后复出', '低谷修复', '新教练上任', '战术改阵', '雨战', '高温客场', '人工草场', '强敌对位', '保级压力', '争冠压力', '德比周', '更衣室调整', '队长缺阵', '核心队友受伤', '纪律风波', '媒体关注', '球迷质疑', '数据分析复盘', '冬季轮换', '夏季窗口', '欧战资格', '国内杯决赛', '半决赛', '点球大战', '最后五轮', '客场长途', '密集赛程', '赛季收官', '续约谈判', '租借选择', '回归母队', '新城市适应', '家庭压力', '经纪人建议', '职业转型', '年龄增长', '退役规划', '赛季规划'];
