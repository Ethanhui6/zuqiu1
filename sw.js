const VERSION='green-pitch-v20.0.0-20260803-1';
...
const CORE=[
  ...
  './src/components/appShell.js','./src/components/gamePaceSheet.js','./src/components/guidanceBanner.js','./src/components/clubCard.js','./src/components/clubCrest.js','./src/components/clubDetailSheet.js','./src/components/facilityCenterSheet.js','./src/components/eventCard.js','./src/components/formControls.js','./src/components/playerCard.js','./src/components/radarChart.js','./src/components/sheet.js','./src/components/talentCard.js','./src/components/toast.js',
  ...
  './src/styles/theme.css','./src/styles/base.css','./src/styles/components.css','./src/styles/pages.css','./src/styles/mobile-foundation.css','./src/styles/animations.css','./src/styles/v19-guidance.css','./src/styles/v20-product.css',
