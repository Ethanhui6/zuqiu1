const CACHE='pitchlife-v8-20260802';
const CORE=['./','index.html','styles.css','app.js','manifest.webmanifest','icon.svg','data/clubs.json','data/players.json','data/trophies.json'];
