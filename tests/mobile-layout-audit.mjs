...
try{
  ...
  await page.locator('[data-route="match"]').click();assert.equal(await page.locator('[data-match-interaction]').count(),0);await page.locator('[data-play]').click();assert.ok(await page.locator('.sheet [data-mini-pitch-host]').count());await page.locator('.sheet [data-home]').waitFor();
