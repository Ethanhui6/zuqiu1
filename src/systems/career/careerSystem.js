...
export function createNewSave(draft,club,slotId){
  ...
  const save={schemaVersion:SAVE_SCHEMA,gameVersion:APP_VERSION,createdAt:Date.now(),updatedAt:Date.now(),rng:{...rng.snapshot()},settings:{theme:'light',reducedMotion:false,animationMode:'standard',pace:{...storedPace,mode:draft.paceMode||storedPace.mode||'standard',autoPause:{...DEFAULT_AUTO_PAUSE,...(storedPace.autoPause||{})}}},
    ...
    career:{year:2026,season:1,month:1,seasonProgress:0,clubId:club.id,squadLevel:draft.academyOffer.squad,teamRole:draft.academyOffer.role,contract:{type:'青训合同',years:draft.academyOffer.contractYears,weeklyWage:draft.academyOffer.weeklyWage,releaseClause:0,appearancePromise:'根据青年队表现逐步培养'},seasonStats:emptySeasonStats(),careerStats:{apps:0,goals:0,assists:0,cleanSheets:0,titles:0,nationalApps:0,nationalGoals:0,bestRating:0,hatTricks:0,bigGames:0,saves:0,tackles:0},history:[],clubHistory:[club.id],records:{},trophies:[],pending:{event:openingHook(draft,club,rng),match:null,offers:[],delayedEffects:[]},eventMemory:{triggered:[],recentEventIds:[],recentTags:[],recentCategories:[],recentTitles:[],recentTemplateTitles:[],recentChoiceSignatures:[],recentPersons:[],recentOpponents:[],choices:[],chainsOpen:[],chainsStarted:[],chainsClosed:[],cooldowns:{},typeCounts:{},generatedCount:0,duplicateCount:0,lastAvailableCount:0,lastFilteredCount:0,lastChoiceSignature:''},hiddenConsequences:[],transferHistory:[],offerHistory:[],rejectedClubs:[],transferWindows:{},actionLocks:{},facilities:{visits:[],locks:{}},loan:null,trainingPlan:'tactics',retirement:null,gameClock:{currentDate:'2026-07-01',seasonId:'2026-27',seasonStartDate:'2026-07-01',seasonEndDate:'2027-06-30',competitionWeek:1,calendarWeek:27,currentPhase:'preseason',currentTransferWindow:'summer',lastProcessedDate:'2026-07-01'},calendar:{week:1,absoluteWeek:1,nextEventDate:'2026-07-08'},weekState:{trainingDone:true,eventDone:false,matchDone:false},schedule:null,competitionState:{level:Number(club.level||1),continentalQualified:false,history:[]},strategies:{...DEFAULT_STRATEGIES},objectives:{season:1,cycleId:0,generatedDate:null,expiresDate:null,candidates:[],active:[],completed:[],rewarded:[]},advance:{running:false,lastSummary:null,history:[],resumeTarget:null,activeRequest:null},weeklyPlan:{selected:'balanced',appliedWeeks:[],history:[]},aiDirector:{lastReviewDate:null,nextReviewDate:null,focus:null,recommendations:[],eventBias:{},history:[]},squadCompetition:{seasonId:null,competitors:[],rank:4,lastUpdatedDate:null},agent:null,messages:{items:[],seen:[],lastGeneratedDate:null},formMomentum:{value:0,history:[]},traits:{progress:{},unlocked:[]},worldDynamics:{lastMonth:null,items:[],clubStates:{}},lastMatchResult:null,majorNodes:[]},
    status:{fitness:88,morale:72,form:55,fatigue:8,injury:null,suspension:0,coachTrust:45},relations:createRelations(),fans:createFans(),finance:{cash:2000,marketValue:120000,weeklyWage:draft.academyOffer.weeklyWage,sponsorships:[]},achievements:{unlocked:[],notified:[],score:0},meta:{migrationNotes:[],checksum:'',ranking:{runId:null,eligible:false,lastSequence:0,lastSyncAt:null,status:'local-only'}}}
  return save;
}
...
export function shouldRetire(save){const age=save.player.age;const injury=save.status.injury?.severity||0;if(age>=38)return true;if(age>=35&&save.player.ovr<62)return true;if(age>=34&&injury>.7)return true;return false}
