...
export function createNewSave(draft,club,slotId){
  ...
  const save={schemaVersion:18,gameVersion:'18.5.0',createdAt:Date.now(),updatedAt:Date.now(),rng:{...rng.snapshot()},settings:{theme:'light',reducedMotion:false,pace:{mode:draft.paceMode||'standard',speed:'normal',autoPause:{...DEFAULT_AUTO_PAUSE}}},
