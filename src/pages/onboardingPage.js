...
function styleDescription(style){const map={禁区终结者:'专注无球跑位和门前终结，回撤参与较少。',支点中锋:'利用身体保护球权，为队友创造前插空间。',全能前锋:'兼顾推进、做球与终结，对综合能力要求更高。',速度型前锋:'攻击防线身后，以启动和冲刺制造机会。',伪九号:'频繁回撤连接中场，用传球和盘带打乱防线。',古典组织核心:'以视野和传球主导前场节奏，防守负担较轻。',扫荡覆盖型门将:'主动离开门线覆盖身后空间，强调启动、出球和一对一判断。',反越位终结者:'反复攻击最后防线身后，强调启动时机、射门和小范围处理。'};return map[style]||`${style}会改变训练倾向、比赛选择与球队适配。`}
