...
export function matchPage(app,state){
  ...
  root.querySelector('[data-play]')?.addEventListener('click',()=>playerStatus.available===false?app.feedback.emit('failure',playerStatus.copy):app.openMatchStrategy(match,playerStatus));
  return root;
}
