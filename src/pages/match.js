...
export function matchPage(app,state){
  ...
  root.querySelector('[data-play]')?.addEventListener('click',()=>app.playMatch(match,TACTICS.find(t=>t.id===tactic)));
