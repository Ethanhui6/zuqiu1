...
export function trainingPage(app,state){
  ...
  root.innerHTML=`<div class="page-head"><div><h1 class="page-title">训练中心</h1><p class="page-subtitle">本周方案、风险与成长预览</p></div><span class="badge ${done?'green':'orange'}">${done?'本周已完成':'待训练'}</span></div>
