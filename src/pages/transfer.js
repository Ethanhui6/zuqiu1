...
export function transferPage(app,state){
  ...
  root.addEventListener('click',e=>{
    if(e.target.closest('[data-open-world]'))return app.navigate('world');
