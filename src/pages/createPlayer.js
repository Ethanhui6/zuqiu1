...
export function createPlayerWizard(app){
  let step=0;
  const draft={name:'',shirtName:'',birth:'2008-03-18',country:'中国',height:178,weight:70,foot:'右脚',number:18,position:'中场',style:'技术型',club:'ajax'};
