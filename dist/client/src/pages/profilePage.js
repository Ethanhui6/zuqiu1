...
function settings(save,store,onReturnToSlots,repo){
  ...
  card.append(
    el('div',{className:'setting-row setting-row--static'},[el('div',{},[el('strong',{text:'界面外观'}),el('small',{text:'V18.9统一使用iOS浅色界面，并采用无阻挡微反馈。'})]),el('span',{className:'tag tag--accent',text:'浅色'})]),
