...
export function createNewSave(draft,club,slotId){
  ...
  const save={schemaVersion:20,gameVersion:'18.9.0',createdAt:Date.now(),updatedAt:Date.now(),rng:{...rng.snapshot()},settings:{theme:'light',reducedMotion:false,animationMode:'standard',pace:{mode:draft.paceMode||'standard',speed:'normal',autoPause:{...DEFAULT_AUTO_PAUSE}}},
